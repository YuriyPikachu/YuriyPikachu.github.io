...
## 我做了什么？
今年个人博客总共写了六篇文章，一篇kotlin，两篇跨平台Taro跟Flutter。JVM内存模型一篇，Gradle插件一篇，全埋点一篇。用户属性如下。
...
4、如果你在大厂，我也是初入江湖，只能给些思想上的建议。保持热情，了解团队业务，不要只把自己定位成接需求干活的个体，要积极寻找切入点，让自己帮助到团队。
